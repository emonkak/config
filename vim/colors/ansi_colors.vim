...
call s:h('Added', { 'fg': 'green' })
call s:h('Changed', { 'fg': 'blue' })
...
call s:h('DiffAdd', { 'bg': 'green' })
call s:h('DiffChange', { 'bg': 'blue' })
call s:h('DiffDelete', { 'bg': 'red' })
call s:h('DiffText', { 'attr': 'bold' })
call s:h('Directory', { 'fg': 'bright-cyan' })
call s:h('Error', { 'bg': 'red' })
call s:h('ErrorMsg', { 'bg': 'red' })
call s:h('FloatBorder', { 'fg': 'bright-black' })
...
call s:h('StatusLineNC', { 'fg': 'bright-white', 'bg': 'bright-black' })
...
if has('nvim')
  " clear default highlights.
  " https://github.com/neovim/neovim/blob/release-0.10/src/nvim/highlight_group.c#L414
  ...
  highlight default link CurSearch Search
  ...
  highlight default link QuickFixLine Search
  highlight default link String Constant

  highlight default link @punctuation Noise
  highlight default link @tag Keyword
  highlight default link @tag.attribute Type
  highlight default link @tag.delimiter Identifier
  highlight default link @type Type
  highlight default link @type.builtin Type
  highlight default link @type.definition.attribute Typedef
